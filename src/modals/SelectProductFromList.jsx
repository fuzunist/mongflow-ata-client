...
const SelectProductFromList = ({ selectedProduct, selectedCustomer, onContinueOrder }) => {
    ...
    const groupedAttributes = useMemo(() => {
        if (selectedProduct) return groupAttributesByName(selectedProduct.attributes)
        return {}
    }, [selectedProduct])
    ...
    const initialValues = useMemo(() => {
        ...
        return Object.entries(groupedAttributes).reduce((acc, [attrName, attrValues]) => {
        ...
        >
            {({ close }) => (
                <FormikForm
                    ...
                    onSubmit={(values) => onContinueOrder(values, quantity, productType, close, setQuantity, setProductType)}
                >
