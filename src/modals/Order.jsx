    ...
    <div className="flex flex-col gap-4 mb-4">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex-1 flex flex-col gap-2 items-end">
          ...
          <span>
            <span className="font-semibold">{t("order_creation_date")}:</span>{" "}
      ...
      <div className="flex flex-wrap text-center font-semibold">
        ...
        <span className="basis-[calc(12%_-_0.5rem)] mx-1 px-2">
          {t("unitPrice")}
        </span>
        <span className="basis-[calc(24%_-_0.5rem)] mx-1 px-2">
          {t("total")}
      ...
      <div className="flex flex-col gap-2">
        {order.products.map((product, index) => (
          <div className="flex flex-wrap text-center items-center" key={index}>
            <span className="basis-[calc(24%_-_0.5rem)] mx-1 px-2">
