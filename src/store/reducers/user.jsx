...
const user = createSlice({
    ...
    reducers: {
        _setUser: (state, action) => {
            const { userid, username, email, usertype, photo, company_name, phone, fullname, tokens } = action.payload
            state.userid = userid
...
export const { _setUser, _setInformations, _setTokens, _logOut, _setPhoto } = user.actions
