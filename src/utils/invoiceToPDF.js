...
const invoiceToPDF = async (values, products, sets, user, customer, totalPrice, taxRate, orderNumber) => {
    ...
    worksheet.getCell('C33').value = '%50 AVANS ÖDEMESİ + %50 YÜKLEME ÖNCESİ ÖDEME'
    worksheet.getCell('C34').value = 'FCA GEBZE'
    worksheet.getCell('C35').value = '1 GÜN'
    ...
    worksheet.getCell('H33').value = 'DENİZBANK'
